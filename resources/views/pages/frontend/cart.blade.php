            ...
            @if (session('cart'))
                @foreach (session('cart') as $id => $details)
                    ...
                    <tr data-id="{{ $id }}">
                        ...
                        <td data-th="qty">
                            <input type="number" value="{{ $details['qty'] }}" class="form-control qty update-cart" />
                        </td>
                        <td data-th="Subtotal" class="text-center">${{ $details['qty'] }}</td>
